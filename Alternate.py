...
def traverse_job_cards(driver, url):
	...
	driver.get(url)
	mosaic_zone = driver.find_element_by_id("mosaic-provider-jobcards")
	jobElements = mosaic_zone.find_elements_by_tag_name("a")
...
def scrapeData(driver, element):
	...
	side_panel = driver.find_element_by_id("vjs-container-iframe")
